...
public class CloudsController {
    ...
    public void positionClouds(boolean firstTimeArraging) {
        ...
        for(Cloud c: clouds) {
            ...
            if(c.getX() == 0 && c.getY() == 0) {
                ...
                if(!firstTimeArraging && c.getCloudName() != "Dark Cloud")  {
                    ...
                    if(rand > 5) {
                        ...
                        if(randomCollectable == 0) {
                            // spawn a life, if the life count lower than 2
    ...
    public void removeOffScreenCollectables() {
        for(int i=0; i<collectables.size; i++) {
            if(collectables.get(i).getY()-GameInfo.HEIGHT/2f -15 > cameraY) {
                collectables.get(i).getTexture().dispose();
                collectables.removeIndex(i);
               // System.out.println("The collectable remove");
            }
        }
    }
